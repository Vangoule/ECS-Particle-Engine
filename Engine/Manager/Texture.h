...
public:
	...
	inline ILubyte* GetPixels() const { return m_textureData->m_pixels; }
...
private:
	...
	void loadTextureDevIL(const std::string& fileName, GLenum textureTarget, GLfloat filter, GLenum internalFormat, GLenum format, bool clamp, GLenum attachment);
